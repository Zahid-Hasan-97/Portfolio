...
const Skills = () => {
    return (
        <div id='skill' className='scroll-mt-28 max-w-screen-xl mx-auto flex flex-col my-12 min-h-screen '>
            ...
            <div className='w-full flex mt-10'>
                ...
                <div className='w-1/2 ' >
                    ...
                    <div className=' flex items-center '>
                        <div className='grid [grid-template-columns:repeat(1,60px)] [grid-auto-rows:60px] gap-5 my-10'>
            ...
            <div className='flex flex-col items-center gap-10'>
                ...
                <Marquee>
                    <div className='flex w-12 gap-17' >
