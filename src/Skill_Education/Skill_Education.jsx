...
const Skill_Education = () => {
    ...
    return (
        <div id='skill&Edu' className='max-w-screen-xl mx-3 md:mx-auto pt-28 scroll-pt-20'>
            <div className='w-full box-border bg-[linear-gradient(145deg,_#e2e8ec,_#ffffff)] shadow-[5px_5px_15px_#D1D9E6,_-5px_-5px_15px_#ffffff] dark:bg-[linear-gradient(145deg,_#1e2024,_#23272b)] dark:shadow-[10px_10px_19px_#1c1e22,_-10px_-10px_19px_#262a2e]  transition-all duration-[400ms] ease-in-out flex  rounded-xl items-start  align-baseline '>
                ...
                hover:text-blue-500 transition-all duration-[400ms] ease-in-out z-1 ${skill === 'skills' ? 'text-blue-500 box-border bg-[linear-gradient(145deg,_#e2e8ec,_#ffffff)] shadow-[5px_5px_15px_#D1D9E6,_-5px_-5px_15px_#ffffff]  dark:bg-[linear-gradient(145deg,_#1e2024,_#23272b)] dark:shadow-[10px_10px_19px_#1c1e22,_-10px_-10px_19px_#262a2e]  transition-all duration-[400ms] ease-in-out flex  rounded-xl items-center  align-baseline' : ''}`}>Skills</button>
                ...
                hover:text-blue-500 transition-all duration-[400ms] ease-in-out z-1 ${skill === 'education' ? 'text-blue-500 box-border bg-[linear-gradient(145deg,_#e2e8ec,_#ffffff)] shadow-[5px_5px_15px_#D1D9E6,_-5px_-5px_15px_#ffffff] dark:bg-[linear-gradient(145deg,_#1e2024,_#23272b)] dark:shadow-[10px_10px_19px_#1c1e22,_-10px_-10px_19px_#262a2e]  transition-all duration-[400ms] ease-in-out flex  rounded-xl items-center  align-baseline' : ""}`}>Education</button>
