...
const AboutMe = () => {
    return (
        <div id='aboutMe' className='scroll-mt-24 max-w-screen-xl flex flex-col items-center justify-center mt-14 mx-auto'>
            <h1 className='text-5xl text-[#3C3E41] dark:text-[#c4cfde] font-bold pb-14'>About Me</h1>
            ...
            <div className='flex items-center justify-center gap-5'>
                ...
                <div className='w-1/2 box-border bg-[linear-gradient(145deg,_#e2e8ec,_#ffffff)] shadow-[5px_5px_15px_#D1D9E6,_-5px_-5px_15px_#ffffff] dark:bg-[linear-gradient(145deg,_#1e2024,_#23272b)] dark:shadow-[10px_10px_19px_#1c1e22,_-10px_-10px_19px_#262a2e] transition-all duration-[400ms] ease-in-out flex flex-col rounded-xl items-start gap-8 align-baseline p-3.5'>
